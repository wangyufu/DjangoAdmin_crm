...
class Account(AbstractBaseUser, PermissionsMixin):
    ...
    class Meta:
        permissions = (
            ('web_table_index', '可以查看所有的luffyadmin的app'),
            ('web_table_list', '可以查看每张表里所有的数据'),
            ('web_table_list_view', '可以访问表里每条数据的修改页'),
            ('web_table_list_change', '可以对表里的每条数据进行修改'),
            ('web_table_list_filter', '可以查看每张表里所有的数据filter')
        )