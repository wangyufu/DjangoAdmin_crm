# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-07-09 09:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_list', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.ClassList')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('consult_courses', models.ManyToManyField(to='web.Course')),
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='my_consultant', to=settings.AUTH_USER_MODEL)),
                ('referral_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='my_referral', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('menus', models.ManyToManyField(blank=True, null=True, to='web.Menu')),
            ],
        ),
        migrations.CreateModel(
            name='Source',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.CourseRecord')),
        ...
        migrations.AddField(
            ...
            name='contract',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.Contract'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
        ...
        migrations.AddField(
            model_name='account',
            name='customer',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='web.Customer'),
        ),
        migrations.AddField(
            model_name='account',
            name='role',
